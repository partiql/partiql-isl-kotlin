...
class IonSchemaParserTests {
    ...
    fun parametersForRangedConstraintsTest() = listOf(
        // content
    ...
    fun parametersForInlineTypesTest() = listOf(
        // type constraint
    ...
    fun parametersForFieldsTest() = listOf(
    ...
    fun parametersForMiscTypesTest() = listOf(
    ...
    fun parametersForParseIntRangeTest() = listOf(
        ParseTypeTestCase("5") {
    ...
    fun parametersForWholeSchemaTests() = listOf(
        // single type
